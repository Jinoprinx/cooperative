            ...
            {COLORS.map((c) => (
              <TouchableOpacity 
                ...
                style={{ 
                  ...
                  borderWidth: selectedColor === c.value ? 4 : 0,
                  borderColor: colorScheme === 'dark' ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.4)'
                }}
              >
        ...
        <View className="bg-surface border border-border p-6 rounded-3xl mb-8">
          ...
          <View>
            <View className="flex-row justify-between">
              ...
              <Text className="text-foreground text-xs font-bold">{tenantDetails?.subdomain || 'unknown'}.cooperatives.io</Text>
            </View>
            <View className="flex-row justify-between mt-3">
              <Text className="text-foreground/45 text-xs">Organization ID</Text>
              <Text className="text-foreground text-xs font-bold">{tenantDetails?._id || 'pending'}</Text>
            </View>
            <View className="flex-row justify-between mt-3">
